...
public class InitializationHelper {
    ...
    public static SSLCommerzInitialization sslCommerzInitializatoin(SDKDataModel sdkDataModel) {
        SSLCommerzInitialization sslCommerzInitialization = new SSLCommerzInitialization(
                sdkDataModel.getInitializer().getStoreId(), sdkDataModel.getInitializer().getStorePasswd(),
                sdkDataModel.getInitializer().getTotalAmount(), sdkDataModel.getInitializer().getCurrency(),
                sdkDataModel.getInitializer().getTranId(), sdkDataModel.getInitializer().getProductCategory(),
    ...
    public static SSLCEMITransactionInitializer initiateEmiTransaction(SDKDataModel sdkDataModel) {
        ...
        // if (sdkDataModel.getEmiOptions() != null) {
        // emitrans.setEmiOptions(sdkDataModel.getEmiOptions());
