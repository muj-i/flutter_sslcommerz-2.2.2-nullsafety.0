...
@property (nonatomic) enum OfferOptions noOffer;
...
@property (nonatomic, copy) NSString * _Nullable userRefer;
...
typedef SWIFT_ENUM(NSInteger, OfferOptions, open) {
  OfferOptionsWithDiscountOffer = 0,
  OfferOptionsNoDiscountOffer = 1,
};
...
@property (nonatomic, copy) NSString * _Nullable productCategory;
@property (nonatomic, strong) ProductProfile * _Nullable productProfile;
...
- (nonnull instancetype)initWithDiscountAmount:(double)discountAmount OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// an object of  <code>IntegrationInformation</code> contains required information to initiate <code>SSLCommerz</code> object
@property (nonatomic, strong) IntegrationInformation * _Nonnull integrationInformation;
/// an object of  <code>EMIInformation</code> contains optional emi informations to initiate <code>SSLCommerz</code> object
@property (nonatomic, strong) EMIInformation * _Nullable emiInformation;
/// an object of  <code>CustomerInformation</code> contains optional customer informations to initiate <code>SSLCommerz</code> object, will help to track customer after payment
@property (nonatomic, strong) CustomerInformation * _Nullable customerInformation;
/// an object of  <code>ShipmentInformation</code> contains optional shipment informations to initiate <code>SSLCommerz</code> object, will help to manage shipment
@property (nonatomic, strong) ShipmentInformation * _Nullable shipmentInformation;
/// an object of  <code>ProductInformation</code> contains optional product informations to initiate <code>SSLCommerz</code> object, will help to manage product inventory
@property (nonatomic, strong) ProductInformation * _Nullable productInformation;
/// an object of  <code>AdditionalInformation</code> contains optional additional informations to initiate <code>SSLCommerz</code> object, will help to generate report easily
@property (nonatomic, strong) AdditionalInformation * _Nullable additionalInformation;
/// <code>SSLCommerzDelegate</code> will help handle callback and result of the transaction .
@property (nonatomic, strong) id <SSLCommerzDelegate> _Nullable delegate;
/// Initiate <code>SSLCommerz</code> only using required information
/// \param integrationInformation an object of  <code>IntegrationInformation</code> contains required information to initiate <code>SSLCommerz</code> object
///
...
/// Initiate <code>SSLCommerz</code> only using required and optional information
/// \param integrationInformation an object of  <code>IntegrationInformation</code> contains required information to initiate <code>SSLCommerz</code> object
///
/// \param emiInformation an object of  <code>EMIInformation</code> contains optional emi informations to initiate <code>SSLCommerz</code> object
///
/// \param customerInformation an object of  <code>CustomerInformation</code> contains optional customer informations to initiate <code>SSLCommerz</code> object, will help to track customer after payment
///
/// \param shipmentInformation an object of  <code>ShipmentInformation</code> contains optional shipment informations to initiate <code>SSLCommerz</code> object, will help to manage shipment
///
/// \param productInformation an object of  <code>ProductInformation</code> contains optional product informations to initiate <code>SSLCommerz</code> object, will help to manage product inventory
///
/// \param additionalInformation an object of  <code>AdditionalInformation</code> contains optional additional informations to initiate <code>SSLCommerz</code> object, will help to generate report easily
///
...
/// will launch the the SDK with UI
/// \param viewController A sub class object of <code>UIViewController</code>
///
/// \param isTestMode SDK launch  mode : <code>Boolean</code> (true->sandbox, false->live)
///
...
- (void)sdkClosedWithReason:(NSString * _Nonnull)reason;
@end
